...
import com.graduationproject.util.ExcelBean;
...
public class ExcelUtil {
    ...
    public static void createFont(XSSFWorkbook workbook) {
        ...
        fontStyle.setFillForegroundColor(IndexedColors.BLUE.getIndex());
        fontStyle.setFillForegroundColor(HSSFColor.SKY_BLUE.index);
...
//                		System.out.println("1:" + rtn);
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                        rtn = sdf.format(rtn);
//                		System.out.println("2:" + rtn);
                        //value = DateUtil.getDateFormat((Date)rtn);
                    }
//                    if (rtn instanceof Date) {  
...
//                    } else 
                    if((rtn instanceof Integer) && (Integer.valueOf(rtn.toString())<0 )){
                        value="--";
                    }else {
                        value = rtn.toString();
                    }
