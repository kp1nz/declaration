...
<div data-options="region:'south',title:'footer',split:true,noheader:true,"
     style="height:40px;line-height:30px;text-align:center;background:#2D3E50;"><font color="#fff">Copyright&nbsp;&copy;2019
    毕业设计项目申报系统</font></div>
<div data-options="region:'west',title:'导航菜单',split:true,iconCls:'icon-world'," style="width:175px;padding:0px;">
    ...
    <div class="easyui-accordion" data-options="fit:false,border:false,animate:true">
        ...
        <div title="用户信息管理" data-options="iconCls:'icon-user_manager'" style="padding:10px">
            <a href="javascript:openTab('全部用户列表','${pageContext.request.contextPath }/user/admin/userManage.do','icon-list_all')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-list_all'"
               style="width: 125px;padding:2px 8px 2px 5px;">全部用户列表</a>
            <a href="javascript:openTab('申报人员列表','${pageContext.request.contextPath }/user/admin/userManage.do?user_type=5','icon-user_list')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-user_list'"
               style="width: 125px;padding:2px 8px 2px 5px;">申报人员列表</a>
            <a href="javascript:openTab('系部管理员列表','${pageContext.request.contextPath }/user/admin/userManage.do?user_type=3','icon-list_success')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-list_success'" style="width: 125px;padding:2px 8px 2px 5px;">系部管理员列表</a>
            <a href="javascript:openTab('评审专家列表','${pageContext.request.contextPath }/user/admin/userManage.do?user_type=4','icon-list_failure')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-list_failure'" style="width: 125px;padding:2px 8px 2px 5px;">评审专家列表</a>
            <a href="javascript:openTab('项目管理员列表','${pageContext.request.contextPath }/user/admin/userManage.do?user_type=2','icon-user_list3')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-user_list3'"
               style="width: 125px;padding:2px 8px 2px 5px;">项目管理员列表</a>
        </div>
        <div title="申报控制开关" data-options="iconCls:'icon-item_control'" style="padding: 10px">
            <a href="javascript:openTab('申报控制管理','${pageContext.request.contextPath }/configSwitch.do','icon-switch')"
               class="easyui-linkbutton"
        ...
        <div title="项目信息管理" data-options="iconCls:'icon-item'" style="padding:10px;">
            <a href="javascript:openTab('项目类别管理','${pageContext.request.contextPath }/user/admin/itemType.do','icon-type')"
               class="easyui-linkbutton"
